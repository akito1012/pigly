...
<div class="initial__inner">
    <form action="" class="initial__form">
        <div class="initial__item">
            <label for="current_weight" class="initial__label">現在の体重</label>
            <input type="text" class="initial__input" id="current_weight" name="current_weight" placeholder="現在の体重を入力">
        </div>
        <div class="error">error</div>
        <div class="initial__item">
            <label for="target_weight" class="initial__label">目標体重</label>
            <input type="text" class="initial__input" id="target_weight" name="target_weight" placeholder="目標体重を入力">
        </div>
        <div class="error">error</div>
